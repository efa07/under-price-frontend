            ...
            return (
              <Link key={category.slug} href={`/products?category=${category.slug}`}>
                ...
                >
                  ...
                  <div className="absolute bottom-6 right-6 z-20 w-14 h-14 rounded-full bg-black/20 backdrop-blur-md flex items-center justify-center text-white transition-all duration-500 group-hover:bg-white border text-transparent border-white/20 shadow-lg overflow-hidden group-hover:scale-205">
                    {/* Default Icon */}
                    ...
                    <span className={`text-sm font-extrabold uppercase tracking-widest absolute transition-all duration-500 opacity-0 scale-50 translate-y-4 group-hover:translate-y-0 group-hover:opacity-100 group-hover:scale-100 text-transparent ${hoverTextColor}`}>
                      Shop
                    </span>
                  </div>
                </Card>
